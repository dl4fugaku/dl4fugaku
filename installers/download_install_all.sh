...
TRANSFORMER_DL_JOB_ID=$(sbatch ./download_transformers.sh) || exit 7
TRANSFORMER_JOB_ID=$(sbatch -d afterok:${VISION_JOB_ID##* },${TRANSFORMER_DL_JOB_ID##* } install_transformers.sh) || exit 8
